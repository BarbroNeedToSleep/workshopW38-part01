...
class AppUserRepositoryTest {
    ...
    void findByUsername() {
        ...
        AppUser user = new AppUser("john", "pass123", LocalDate.now(), details);
    ...
    void findByRegDateBetween() {
        ...
        AppUser user = new AppUser("jane", "pass456", today, details);
        appUserRepository.save(user);

        List<AppUser> users = appUserRepository.findByRegDateBetween(today.minusDays(1), today.plusDays(1));
    ...
    void findByUserDetails_Id() {
        ...
        AppUser user = new AppUser("mike", "pass789", LocalDate.now(), details);
        appUserRepository.save(user);
    ...
    void findByUserDetails_EmailIgnoreCase() {
        ...
        AppUser user = new AppUser("sara", "pass321", LocalDate.now(), details);
        appUserRepository.save(user);
